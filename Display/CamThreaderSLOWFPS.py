...
class CameraThread(Thread): 
    ...
    def __init__(self): 
        ...
        self.camera.set_controls({"ScalerCrop": offset + size , "FrameRate": (38), "Sharpness": (16), "AeEnable": (True), "AeConstraintMode": 0, "AeExposureMode": 0 })#,, "Saturation": 0.0 ,"AeConstraintMode": ('AeConstraintModeEnum', 'Shadows')  })#"AnalogueGain": (1.0) , }) #, "AnalogueGain": 2.0
